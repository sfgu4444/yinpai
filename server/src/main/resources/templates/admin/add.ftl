...
<div class="x-body">
    <form class="layui-form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="password" id="adminPass" name="adminPass" required="" lay-verify="required" autocomplete="off" class="layui-input" placeholder="请输入密码">
            </div>
            <div class="layui-form-mid layui-word-aux">
                密码为6~16个字符
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="password" id="adminCheckPass" name="adminCheckPass" required="" lay-verify="required" autocomplete="off" class="layui-input" placeholder="请输入确认密码">
            </div>
            <div class="layui-form-mid layui-word-aux">
                请保持与密码一致
            </div>
        ...
        <div class="layui-form-item type-2">
            ...
            <div class="add_pic">
                <div id="cover">
                    ...
                    <img src="/static/images/camera.png" width="200" id="avatarUrl">
                </div>
            </div>
        </div>
        ...
        <div class="layui-form-item type-2">
            ...
            <div class="add_pic">
                <div id="cover_b">
                    ...
                    <img src="/static/images/camera.png" width="200" id="backgroundUrl">
                </div>
            </div>
        </div>
<!--
...
2021 - 1-1 注释掉
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="monthPayPrice" name="monthPayPrice" autocomplete="off" class="layui-input" placeholder="请输入月付价格">
            </div>
            <div class="layui-form-mid layui-word-aux">
                不填表示不支持此方式
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="quarterPayPrice" name="quarterPayPrice" autocomplete="off" class="layui-input" placeholder="请输入季付价格">
            </div>
            <div class="layui-form-mid layui-word-aux">
                不填表示不支持此方式
            </div>
        ...
        <div class="layui-form-item">
            <label for="yearPayPrice" class="layui-form-label">
                年付价格
            </label>
            <div class="layui-input-inline">
                <input type="text" id="yearPayPrice" name="yearPayPrice" autocomplete="off" class="layui-input" placeholder="请输入年付价格">
            </div>
            <div class="layui-form-mid layui-word-aux">
                不填表示不支持此方式
            </div>
